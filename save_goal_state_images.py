...
def main():
    ...
    try:
        ...
        while True:
            ...
            # Save Images of Chair and Origin AruCo markers when required Markers are Detected
            if utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_1_frame, 'Chair_1') is not None and \
                utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_1_frame, 'Chair_2') is not None and \
                utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_2_frame, 'Chair_3') is not None and \
                utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_2_frame, 'Chair_4') is not None:
                print("Saved AruCo marker Images for Chairs and Origin")
                cv2.imwrite('aruco_markers_for_chairs_and_origins_image_1.jpg', save_image_1)
                cv2.imwrite('aruco_markers_for_chairs_and_origins_image_2.jpg', save_image_2)
