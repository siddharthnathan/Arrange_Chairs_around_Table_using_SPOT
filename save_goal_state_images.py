...
def main():
    ...
    try:
        ...
        while True:
            ...
            if utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_1_frame, 'Origin') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_1_frame, 'Right_Wall_1') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_1_frame, 'Right_Wall_2') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_2_frame, 'Origin') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_2_frame, 'Left_Wall_1') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_2_frame, 'Left_Wall_2'):
            ...
            # # Save Images of Origin AruCo markers when required Markers are Detected
            elif utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_1_frame, 'Chair_1') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_1_frame, 'Chair_2') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_2_frame, 'Chair_3') and utils.get_pose_of_aruco_tag(aruco_tags_data_wrt_camera_2_frame, 'Chair_4'):
